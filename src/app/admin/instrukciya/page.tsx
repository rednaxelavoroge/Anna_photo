...
const CHAPTERS = [
  ...
  { id: "teksty", num: "09", title: "Тексты, СМИ, ТВ, фототуры, контакты" },
        ...
        <Chapter id="galerei" num="07" title="Бэкстейдж, отзывы, воркшопы, фотоархив">
          ...
          <Bullets
            items={[
              ...
              <>Воркшопы лежат на вкладке «Обучение» внизу; фотоархив — на вкладке «Обо мне и СМИ» внизу.</>,
            ]}
          />
        </Chapter>
        ...
        <Chapter id="roliki" num="08" title="Ролики с телефона">
          ...
          <Bullets
            items={[
              ...
              <>Как только панель прочитает ролик, рядом с кнопкой появится кадр из него: видно, что заливается именно то, что нужно.</>,
              <>В списках ролик показан кадром из себя, со значком ▶ в углу. Нажимать для этого ничего не нужно.</>,
              <>Если ролик не доехал, панель напишет об этом словами. Просто выберите его ещё раз.</>,
            ]}
          />
        </Chapter>

        <Chapter id="teksty" num="09" title="Тексты, СМИ, ТВ, фототуры, контакты">
          <Bullets
            items={[
              <>
        ...
        <Chapter id="sohranit" num="11" title="После «Сохранить» и если удалили лишнее">
          <Bullets
            items={[
              ...
              <>
                Пока файл едет на сайт, под кадром написано «Загружено, едет на сайт», а сам кадр виден — это ваша фотография, панель её запомнила. Подпись пропадёт сама, когда файл доедет; обновлять страницу для этого не нужно.
              </>,
