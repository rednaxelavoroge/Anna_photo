    ...
    <div className="min-h-screen bg-paper">
      <div className="mx-auto flex max-w-2xl flex-col gap-12 px-5 py-12 md:px-8 md:py-16">
        ...
        <Chapter id="lenta" num="03" title="Избранное на главной странице">
          ...
          <Bullets
            items={[
              ...
              <>
                <Field>Заголовок</Field> — крупная надпись. «Избранные съёмки», «К Новому году» — что нужно.
              </>,
              <>
        ...
        <Chapter id="poryadok" num="05" title="Порядок: что за чем стоит">
          <p className="text-[0.95rem] leading-relaxed text-ink">
            Порядок меняется перетаскиванием: возьмите карточку мышью и отпустите там, где ей место.
            На телефоне — нажмите на неё, подержите мгновение (она чуть приподнимется) и ведите пальцем;
            отпустили — встала. Пока держите меньше — страница листается как обычно.
          </p>
          <p className="mt-3 text-[0.95rem] leading-relaxed text-ink">
            Стрелки <Btn>↑</Btn> <Btn>↓</Btn> никуда не делись: ими удобно поправить на одну позицию.
            И там, и там переставилось — и сразу сохранилось, отдельной кнопки не нужно.
          ...
          <Bullets
            items={[
              ...
              <>
                <strong className="font-semibold">Кадры внутри раздела.</strong> Вкладка <Btn>Кадры</Btn>: карточку можно перетащить. Стрелки появляются, когда выбран один раздел, — пока выбрано «Все разделы», их нет.
              </>,
              <>
                <strong className="font-semibold">Кадры бэкстейджа.</strong> Вкладка <Btn>Бэкстейдж</Btn>: подпись, файл, кнопка <Btn>Опубликовать</Btn>. Стрелки под каждым кадром. Номер — его место в ленте.
              </>,
              <>
                <strong className="font-semibold">Фотографии одного кадра.</strong> Внутри окна: перетащите снимок на новое место или подвиньте стрелками <Btn>←</Btn> <Btn>→</Btn> под ним. Первый помечен словом «Обложка» — он и станет обложкой кадра.
              </>,
            ]}
          />
        ...
        <Chapter id="foto-video" num="06" title="Фотографии и видео в кадре">
          ...
          <Bullets
            items={[
              ...
              <>
                <strong className="font-semibold">Ролик с телефона.</strong> Поле <Field>Ролик с телефона</Field> внизу окна: выберите файл как есть, ничего заранее делать не надо. Панель покажет проценты отправки, потом сама уменьшит ролик — это минута-две — и поставит его в список файлов кадра. На сайте он будет с проигрывателем. До 200 МБ.
              </>,
              <>
                Пока ролик готовится, окно можно не закрывать. Если что-то не так — панель скажет
                прямо, чем именно: не тот файл, слишком тяжёлый, не получилось уменьшить. Испорченный
                ролик на сайт не попадёт: перед публикацией панель сверяет, что он не оборвался и что
                звук на месте.
              </>,
              <>
                <strong className="font-semibold">Видео с YouTube.</strong> Поле <Field>Видео (YouTube id или ссылка)</Field> — для роликов, которые уже лежат на YouTube. Свой ролик туда выкладывать больше не нужно.
              </>,
            ]}
          />
        </Chapter>
        ...
        <Chapter id="melochi" num="10" title="Мелочи, которые стоит знать">
          <Bullets
            items={[
              ...
              <>
                Названия разделов правятся свободно: адрес страницы за ним не тянется, ссылки не ломаются. Новый раздел заводится кнопкой <Btn>+ Добавить новый раздел</Btn>.
              </>,
              <>
